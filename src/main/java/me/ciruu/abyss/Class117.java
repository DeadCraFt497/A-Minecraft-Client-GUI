...
implements Class631 {
    ...
    private final void Method4062() {
        GLProjection.Method2815(this.Method4058(), this.Method291(), this.Method4058() + this.Method4060(), this.Method291() + this.Method4059(), this.Field3399.getBoolean18() ? Color.Field570.Method720() : Color.Field570.Method721());
        if (this.Method290()) {
            ...
            float f7 = f - 6.0f;
            GLProjection.Method2828(f2, f3, f4, f5, f6, f7, this.Field3399.getBoolean18() ? Color.Field570.Method720().getRGB() : Color.Field570.Method721().getRGB());
        }
    }
    ...
    public void Method4073(int n, int n2) {
        ScreenObj.Method3843(this, n, n2);
    }

    public void Method4074(int n) {
        ScreenObj.Method3848(this, n);
    }

    public boolean Method4063(int n, int n2) {
        return ScreenObj.Method3849(this, n, n2);
    }
